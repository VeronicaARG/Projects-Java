...
ControladoraLogica controlL = null;
    ...
    private void initComponents() {
        ...
        jButton3.setFont(new java.awt.Font("Ebrima", 2, 12)); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (tipo.equals("Admin")) {
            CrearDato crear = new CrearDato(usuario,tipo);
            crear.setVisible(true);
            crear.setLocationRelativeTo(null);
            this.setVisible(false);
        } else {
            mostrarMensaje("Eliminar","No tienes los permisos para crear un empleado","Error");
        }
