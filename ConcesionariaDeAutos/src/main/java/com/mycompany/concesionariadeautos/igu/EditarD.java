...
Auto autito;
    ...
    private void initComponents() {
        ...
        EditarBoton.setBackground(new java.awt.Color(51, 255, 51));
        EditarBoton.setFont(new java.awt.Font("Ebrima", 2, 12)); // NOI18N
        EditarBoton.setForeground(new java.awt.Color(0, 102, 102));
        ...
        Obligatorio1.setForeground(new java.awt.Color(255, 51, 51));
        Obligatorio1.setText("*");

        Obligatorio2.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        Obligatorio2.setForeground(new java.awt.Color(255, 51, 51));
        Obligatorio2.setText("*");

        Subtitulo.setFont(new java.awt.Font("Ebrima", 2, 14)); // NOI18N
        Subtitulo.setForeground(new java.awt.Color(255, 51, 0));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(EditarBoton, javax.swing.GroupLayout.DEFAULT_SIZE, 139, Short.MAX_VALUE)
                    .addComponent(BotonEliminar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(61, 61, 61))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(139, 139, 139)
                .addComponent(Subtitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(34, 34, 34)
                        .addComponent(EditarBoton, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(35, 35, 35)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void EditarBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarBotonActionPerformed
        if (!TxtMarca.getText().equals("")) {
            if (!TxtModelo.getText().equals("")) {
                ...
                String patente = TxtPatente.getText();
                String puertas = (String) TxtEspecialPuertas.getSelectedItem();     
                controlL.modificarAuto(autito,modelo,marca,color,motor,patente,puertas);
                mostrarMensaje("Realizado","Se editaron los datos correctamente","Realizado");
                VerD ver = new VerD();
                ver.setVisible(true);
    ...
    private void cargarDatos(int id) {
        this.autito = controlL.agarrarAuto(id);
        TxtModelo.setText(autito.getModelo());
        TxtMarca.setText(autito.getMarca());
        TxtMotor.setText(autito.getMotor());
        TxtPatente.setText(autito.getPatente());
        TxtEspecialColor.setSelectedItem(autito.getColor());
        TxtEspecialPuertas.setSelectedItem(autito.getCantidadPuertas());
