package com.ejercicioIntegrador.EjercicioIntegradorSpringBoot;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

@SpringBootApplication
public class EjercicioIntegradorSpringBootApplication {

	public static void main(String[] args) {
		SpringApplication.run(EjercicioIntegradorSpringBootApplication.class, args);
	}
        // Objetivo
        ...
        // a. Métodos HTTP: GET
        // b. Endpoint: 
        // localhost:8080/ventas/productos/{codigo_veta}
